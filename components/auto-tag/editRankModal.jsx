...
export default function EditRankModal({
  rankEditInputs,
  handleEditRankInputChange,
  handleClose,
  handleEditRankForm = null,
}) {
  return (
    <div>
      <div
      ...
      >
        <div
          ...
          role="document"
        >
          <form className="modal-content" onSubmit={handleEditRankForm}>
            <div className="modal-header">
              <h4 className="modal-title fw-bold">Edit Rank</h4>
              <button
                type="button"
                className="btn-close"
                onClick={handleClose}
                ...
                <div className="row mx-0">
                  <div className="col-8 mb-4">
                    ...
                    <input
                      ...
                      name="name"
                      value={rankEditInputs.name}
                      onChange={handleEditRankInputChange}
                    />
                  </div>
                  <div className="col-4 mb-4">
                    ...
                    <div className="select--single-wrapper">
                      <select
                        ...
                        name="localization"
                        value={rankEditInputs.localization}
                        onChange={handleEditRankInputChange}
                      >
