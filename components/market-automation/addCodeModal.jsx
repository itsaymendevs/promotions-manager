...
export default function AddCodeModal({
  codeInputs,
  handleAddCodeInputChange,
  handleClose,
  handleAddCodeForm = null,
}) {
  return (
    <div
    ...
    >
      <div
        ...
        role="document"
      >
        <form className="modal-content" onSubmit={handleAddCodeForm}>
          <div className="modal-header">
            <h4 className="modal-title fw-bold">New Promotion Code</h4>
            <button
              type="button"
              className="btn-close"
              onClick={handleClose}
