    ...
    <div>
      ...
      >
        <div
          ...
          role="document"
        >
          <form className="modal-content" onSubmit={handleAddUserForm}>
            <div className="modal-header">
              <h4 className="modal-title fw-bold">New User</h4>
              <button
                type="button"
                className="btn-close"
                onClick={handleClose}
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.generalUpdatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.autoTagCreatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.autoTagUpdatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.emailCampaignCreatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.emailCampaignUpdatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.SMSCampaignCreatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.SMSCampaignUpdatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.CodeCampaignCreatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.CodeCampaignUpdatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.reportsCreatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.guestsCreatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.guestsUpdatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.accessCreatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={userInputs.accessUpdatePermission}
                          onChange={handleAddUserInputChange}
                        />
                      </div>
                    </div>
